...
public interface MessageBroker {
     ...
     */
    <T> void subscribeEvent(Class<? extends bgu.spl.mics.Event<T>> type, bgu.spl.mics.Subscriber s);
     ...
     */
    void subscribeBroadcast(Class<? extends bgu.spl.mics.Broadcast> type, bgu.spl.mics.Subscriber s);
